...
namespace PLAYER
{
	//static Any GET_PLAYER_PED(Player player) { return invoke<Any>(0x43A66C31C68491C0, player); } // 0x43A66C31C68491C0 0x6E31E993
	...
	static void CHANGE_PLAYER_PED(int* p0, Ped ped, BOOL p, BOOL p3) { invoke<Void>(0x048189FAC643DEEE, p0, ped, p, p3); } // 0x048189FAC643DEEE 0xBE515485
	...
	static void SET_PLAYER_TEAM(Vehicle player, Player team) { invoke<Void>(0x0299FA38396A4940, player, team); } // 0x0299FA38396A4940 0x725ADCF2
...
namespace ENTITY
{
	...
	static void SET_ENTITY_VELOCITY(Vehicle* entity, float x, float y, float z) { invoke<Void>(0x1C99BB7B6E96D16F, entity, x, y, z); } // 0x1C99BB7B6E96D16F 0xFF5A1988
...
namespace PED
{
	...
	static BOOL _CAN_PED_SEE_PED(Any Any, Player Player) { return invoke<BOOL>(0x6CD5A433374D4CFB, Any, Player); } // 0x6CD5A433374D4CFB 0x74A0F291
...
namespace VEHICLE
{
	static Any GET_VEHICLE_XENON_COLOUR(Vehicle veh) { return invoke<Any>(0x3DFF319A831E0CDB, veh); } // EE21293DAD47C9513D53892    
	static void SET_VEHICLE_XENON_COLOUR(Vehicle veh, int colourIndex) { invoke<Void>(0xE41033B25D003A07, veh, colourIndex); }
	...
	static void SET_VEHICLE_TIMED(Vehicle vehicle, Ped ped, BOOL toggle) { invoke<Void>(0x2E0A74E1002380B1, vehicle, ped, toggle); } // 0x2E0A74E1002380B1 0xDB8CB8E2
...
namespace OBJECT
{
	...
	static void _ENABLE_OBJECT_LOD(Object object, BOOL toggle) { invoke<Void>(0x77F33F2CCF64B3AA, object, toggle); } // 0x77F33F2CCF64B3AA 0x483C5C88
...
namespace AUDIO
{
	...
	static void _PLAY_AMBIENT_SPEECH_AT_COORDS(char* speechName, char* speechParam, float x, float y, float z, char* p5) { invoke<Void>(0xED640017ED337E45, speechName, speechParam, x, y, z, p5); } // 0xED640017ED337E45 0xA1A1402E
...
namespace STREAMING
{
	...
	static void REQUEST_IPL(char* component)
	{
		static auto oREQUEST_IPL = reinterpret_cast<void(*)(char*)>(Memory::pattern("48 89 5C 24 ? 57 48 83 EC 20 48 8B 05 ? ? ? ? 48 8B F9 4C 8B C1 48 8D 54 24 ? 48 8D 0D ? ? ? ? FF 50 10 8B 18").count(1).get(0).get<void>(0));
...
namespace UI
{
	...
	static void SET_TEXT_SCALE(float x, float y) { invoke<Void>(0x07C837F9A01C34C9, x, y); } // 0x07C837F9A01C34C9 0xB6E15B23
...
namespace NETWORK
{
	...
	static void NETWORK_SESSION_KICK_PLAYER(Player player)
	{
		static auto func = reinterpret_cast<void(*)(Player)>(Memory::pattern("48 83 EC 38 B2 01 E8 ? ? ? ? 48 85 C0 74 21").count(1).get(0).get<void>(0));
		func(player);
	}
	...
	static BOOL NETWORK_DO_TRANSITION_TO_NEW_FREEMODE(int* networkHandle, Any* p1, int players, BOOL p3, BOOL p4, int p5) { return invoke<BOOL>(0x9E80A5BA8109F974, networkHandle, p1, players, p3, p4, p5); } // 0x9E80A5BA8109F974 0xAD13375E
	...
	static Any _POCAK_GAY(Player p0, BOOL* p1) { return invoke<Any>(0x44B37CDCAE765AAE, p0, p1); } // 0x44B37CDCAE765AAE
...
namespace UNK3
{
	static BOOL _NETWORK_SHOP_CHECKOUT_START_2(int transactionID) { return invoke<BOOL>(0x39BE7CEA8D9CC8E6, transactionID); } // 0x39BE7CEA8D9CC8E6
	static BOOL _NETWORK_SHOP_BEGIN_SERVICE_2(int* transactionID, Hash p1, Hash transactionHash, int amount, Hash p4, int mode) { return invoke<BOOL>(0x3C5FD37B5499582E, transactionID, p1, transactionHash, amount, p4, mode); } // 0x3C5FD37B5499582E
	static int _NETWORK_SHOP_GET_PRICE(Hash itemHash, Hash categoryHash, BOOL p2) { return invoke<int>(0xC27009422FCCA88D, itemHash, categoryHash, p2); } // 0xC27009422FCCA88D
