...
#define	OFFSET_PLAYER_INFO_CROUCH_SPD			0x168			//float
...
#define OFFSET_PLAYER_NAME1                     0x5C
...
#define OFFSET_VEHICLE_HANDLING_TRACTION			0x90			//fTractionCurveMin
#define OFFSET_VEHICLE_HANDLING_DEFORM				0xF8			//fDeformationDamageMult
#define OFFSET_VEHICLE_HANDLING_UPSHIFT				0x58
#define OFFSET_VEHICLE_HANDLING_SUSPENSION			0xBC			//fSuspensionForce 

//weapon offsets
#define OFFSET_WEAPON_BULLET_DAMAGE     0xB0            //float                     1.44
#define OFFSET_WEAPON_RELOAD_SPEED	    0x12C           //                          1.44
