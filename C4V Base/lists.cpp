...
std::vector<Hash> weaponsList = {
	0x92A27487, 0x958A4A8F, 0xF9E6AA4B, 0x84BD7BFD, 0xA2719263, 0x8BB05FD7, 0x440E4788, 0x4E875F73, 0xF9DCBF2D, 0xD8DF3C3C, 0x99B507EA, 0xDD5DF8D9, 0xDFE37640, 0x678B81B1, 0x19044EE0, 0xCD274149, 0x94117305, 0x3813FC08, // Melee <- last is the new HATCHET
...
std::vector<char*> weaponNames = {
	"None","WEAPON_KNIFE", "WEAPON_BAT", "WEAPON_ASSAULTSMG", "WEAPON_ADVANCEDRIFLE",
	"WEAPON_COMBATMG", "WEAPON_STUNGUN", "WEAPON_HEAVYSNIPER", "WEAPON_GRENADELAUNCHER",
	"WEAPON_RPG", "WEAPON_MINIGUN", "WEAPON_HEAVYPISTOL","WEAPON_BULLPUPRIFLE", "WEAPON_HOMINGLAUNCHER",
	"WEAPON_FIREWORK", "WEAPON_HEAVYSHOTGUN", "WEAPON_RAILGUN", "WEAPON_FLAREGUN"
};

std::vector<char*> weaponNames1 = {
	"None","KNIFE", "BAT", "ASSAULT SMG", "ADVANCED RIFLE",
	"COMBAT MG","STUNGUN", "HEAVY SNIPER", "GRENADE LAUNCHER",
	"RPG", "MINIGUN","HEAVY PISTOL","BULLPUP RIFLE", "HOMING LAUNCHER",
	"FIREWORK", "HEAVY SHOTGUN", "RAILGUN", "FLAREGUN"
};
...
std::vector<notifyMsg> notificationmessagesoutput = {
	{ "attacked an armored truck", "l" }, { "2", "qd" }, { "3", "d" },
	{ "1", "d" }, { "", "d" }, { "was last and has been destroyed", "l" },
	{ "has started a gang attack", "l" }, { "", "e" }, { "", "e" },
	{ "", "e" }, { "killed a member of your gang", "l" }, { "a member of your gang has just been taken", "n" },
	{ "have delivered to simeon", "mb" }, { "have delivered to simeon", "dmb"/*#*/ }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "has been banked", "vn$" },
	{ "has been stolen", "vn$" }, { "has been removed", "vn$" }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "choosen easy way out", "" },
	{ "was eliminated", "" }, { "", "d" }, { "", "d" },
	{ "requested balistic armor and minigun", "" }, { "equiped balistic armor and minigun", "" }, { "collected shark testosterone", "" },
	{ "took down the Smuggler Plane", "" }, { "the smuggler plane destroyed", "n" }, { "the smuggler plane escaped", "n" },
	{ "took down the smuggler helicopter", "" }, { "the smuggler helicopter destroyed", "n" }, { "the smuggler helicopter escaped", "n" },
	{ "the cop distraction is over...", "nb" }, { "the target vehicle destroyed", "n" }, { "destroyed the target vehicle", "" },
	{ "you took too long to destroy the target vehicle", "n" }, { "killed the moving target player", "" }, { "moving target plr abandoned the.", "" },
	{ "has collected the package", "" }, { "has delivered the package", "" }, { "the package dropped", "n" },
	{ "dead drop delivery time expired", "n" }, { "has abandoned kil list", "" }, { "the kill list vehicle will explode in", "nvb" },
	{ "you're no longer able to take part in kill list", "n" }, { "", "d" }, { "killed a target", "" },
	{ "assaddinated a target", "" }, { "killed an enemy", "" }, { "stoled $ from an ATM", "v$" },
	{ "was killed and dropped $", "v$" }, { "delivered the trailer", "" }, { "transporting the trailer", "" },
	{ "lost the trailer", "" }, { "challenge over plr collected checkpoints", "c" }, { "collected a checkpoint", "" },
	{ "collected a rebreather", "" }, { "equipped a rebreather", "" }, { "challenge over plr collected + notify", "c" },
	{ "delivered special cargo vehicle", "" }, { "destroyed special cargo vehicle", "" }, { "exited the special cargo vehicle", "" },
	{ "collected the special cargo vehicle", "" }, { "sold a special cargo shipment", "o" }, { "", "e" },
	{ "missile lock-on jammer activated", "n" }, { "special cargo is visible to all", "fo" }, { "collected the pink slips", "" },
	{ "", "e" }, { "owner's vehicle unlocked", "n" }, { "delivered vehicle cargo", "" },
	{ "destroyed vehicle cargo", "" }, { "exited the special cargo vehicle", "" }, { "collected vehicle cargo", "" },
	{ "vehicle cargo is visible to all in session", "nf" }, { "moving a gunrunning shipment", "on" }, { "collected a weapon shipment", "" },
	{ "dropped a weapon shipment", "" }, { "destroyed a gunrunning shipment", "" }, { "delivered supplies", "" },
	{ "", "e" }, { "!", "f" }, { "", "d" },
	{ "", "e" }, { "has entered the.", "" }, { "WARNING: You have stolen rival Heist...", "bn" },
	{ "", "d" }, { "destroyed a turreted Vehicle", "" }, { "collected a cargo crate", "" },
	{ "destroyed a cargo crate", "" }, { "collected a time reduction checkpoint", "" }, { "delivered a motorcycle", "" },
	{ "", "d" }, { "rival gangs instructed to destroy bikes...", "bn" }, { "a motorcycle destroyed", "n" },
	{ "delivered business supplies", "" }, { "", "d" }, { "destroyed some product", "" },
	{ "delivered a bag of cash", "" }, { "destroyed some Business Supllies", "" }, { "exited the business supplies vehicle", "" },
	{ "collected some business supplies", "" }, { "business supplies are visible", "of" }, { "collected a package", "" },
	{ "dropped a package", "" }, { "delivered a package", "" }, { "collected product", "" },
	{ "collected the weapons", "" }, { "dropped product", "" }, { "dropped the weapons", "" },
	{ "delivered product", "" }, { "delivered the weapons", "" }, { "delivered a contact to safety", "" },
	{ "destroyed a munition crate", "" }, { "destroyed a van", "" }, { "killed the target", "" },
	{ "is spectating you", "l" }, { "has stopped spectating you", "l" }, { "", "e" },
	{ "", "e" }, { "", "e" }, { "", "e" },
	{ "", "d" }, { "", "d" }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "fastest lap: time ", "l" },
	{ "new personal best: time", "l" }, { "new World Record: time", "l" }, { "was mugged for $.kill the mugger...", "$" },
	{ "the mugger sent by plr to steal from plr killed", "m" }, { "mugger send by you killed", "n" }, { "mugger sent by plr done, but plr has no cash", "m" },
	{ "is now spectating", "l" }, { "you gave plr wanted level", "l" }, { "you hidden your blip 1 minute for", "lv" },//
	{ "you activated ghost organization", "l" }, { "you revealed other players 1 minute for ", "lv" }, { "", "d" },//test these
	{ "", "d" }, { "", "d" }, { "", "d" },
	{ "", "d" }, { "entered 1st place in the challenge", "" }, { "", "d" },
	{ "", "d"/*##*/ }, { "", "d"/*##*/ }, { "", "d" },
	{ "you dismissed by your VIP", "n" }, { "has registered as a VIP", "l" }, { "joined as a bodyguard", "" },//
	{ "quit as a bodygueard", "" }, { "removed from as an associate for causing trouble", "" }, { "eliminated the wanted VIP", "" },//
	{ "the wanted VIP left the area before time end", "n" }, { "the wanted VIP managed to survive the search", "n" }, { "", "d" },//
	{ "", "d" }, { "", "d" }, { "", "d" },
	{ "", "d" }, { "", "d" }, { "you survived being terminated by ", "no" },//
	{ "", "d" }, { "", "d" }, { "destroyed a vehicle", "" },
	{ "a hidden package collected by ", "" }, { "", "d" }, { "", "d" },
	{ "is now the king", "" }, { "killed the king", "" }, { "collected the briefcase", "" },
	{ "dropped the briefcase", "" }, { "has become Ghosted to you", "" }, { "you located the target car", "" },
	{ "idk", "" }

};

std::vector<char*> customfakemoneynotification = {//name, index
	"Banked", "18",
	"Stolen", "19",
	"Removed", "20"
};

std::vector<int> notificationmessagesids = {
	1212634641, 4436344, -2028717802, -718382289, 2062672822, 224946614, 594523614, -2008421099, 235895511, -1229221912,
	1901105394, -372647563, 814173422, 730292763, 691925015, 995275911, 647850070, -213023304, 135615268, -1951108092,
	-312682998, -445083150, -1898801749, -973271510, -1886626261, 217193276, 919980015, -1619484515, -1071437630, -53225426,
	-411673155, -826945811, -973335082, 964364465, -811245037, -428985155, 812303819, 1164264045, 51374557, 2123981180,
	1017199815, -1319965571, -1093032816, 447763156, 1571019575, -356553520, 1383718140, -993241106, 1201352395, 135587098,
	900785611, 686440132, 1852503530, -847256048, 1243910867, -1851137829, 1942381455, -90062717, -1487587798, 562977876,
	-425498044, 923224227, 1313743606, -581594560, -154247493, 1065151484, -2016611441, -141772398, -1779516485, -171630745,
	1163951039, -2088781506, -1055095428, -1812766664, -1177674174, -958531812, 1439411642, 1891989884, -137458861, -305867947,
	883380316, 1256033388, -2076819379, -327250838, -80637543, 1040837057, 510691858, -817540275, -609666513, -1925129103,
	1485501043, 945189178, 1261702590, -1342246711, 639888098, 1203429269, -803497222, -358341859, 54693932, -789052011,
	1939091160, 1088353328, 1674239878, 1663417074, -448511773, 655176766, 1109126586, -1931904162, 2018598612, 71283341,
	-885309830, 123280330, 1364024956, 988010512, -1853913233, 1574458486, 2081255937, 1147724604, 491181769, 619903653,
	2128628037, 609794822, -1380120577, -671906623, -48309252, 1073852419, -38669034, 320958241, 341060676, -702090500,
	1539363700, -1053182163, 230409650, -328592210, -1779624762, 1720846540, 1478892638, 1922057913, 921577838, 564754006,
	376206440, -1952840822, -1155347302, 642798833, 1587225594, 919905478, 609879063, -808004482, 2112954746, -2036495191,
	-1340277092, -1955138895, 1201826887, 2040344337, -1057008853, 1378704051, 1003535133, -325446799, 566882278, 880605634,
	-1443461156, 1168025579, -655091661, 655532819, -1088556695, 638740227, 388184643, -1432184111, -1564367588, -1654382794,
	1456509298, -1293348476, -1571118185, 509431680, 1904532748, 731617970, 549282805, 1397303941, -1107843367, 1856328064,
	1882065379, 14062493, 1372837069, 1128359583, -1256884122, 1435392491, 1992851422
};

std::vector<const char*> nameColor1 = {
	"","~r~","~b~","~g~",
	"~d~","~y~","~p~","~o~",
	"~c~","~m~","~u~", "~q~"
};

std::vector<char*> nameColor = {
...
std::vector<int> inviteSpamTypesInt = {
	0, 1, 2,
	3, 6, 7
};

std::vector<char*> inviteSpamTypes = {
	"APARTMENT", "YACHT", "OFF",
	"CLU", "OFFG", "OFFGS"
};
...
vector<char*> menuHeaderNames = {
	"Logo 1", "Logo 2"
};

vector<string> chatCMD2weap = {
	"parachute", "knife", "bat", "smg", "stungun",
	"sniper", "rpg", "minigun", "pistol", "firework",
	"shotgun", "railgun", "flaregun", "rayminigun", "snowball",
	"raycarbine", "raypistol", "flashlight"
};

vector<string> chatCMD2weapHash = {
	"GADGET_PARACHUTE", "WEAPON_KNIFE", "WEAPON_BAT", "WEAPON_ASSAULTSMG", "WEAPON_STUNGUN",
	"WEAPON_HEAVYSNIPER", "WEAPON_RPG", "WEAPON_MINIGUN", "WEAPON_HEAVYPISTOL", "WEAPON_FIREWORK",
	"WEAPON_HEAVYSHOTGUN", "WEAPON_RAILGUN", "WEAPON_FLAREGUN", "WEAPON_RAYMINIGUN", "WEAPON_SNOWBALL",
	"WEAPON_RAYCARBINE", "WEAPON_RAYPISTOL", "WEAPON_FLASHLIGHT"
};

std::vector<char*> weaponCar = {
	"None","WEAPON_STUNGUN", "WEAPON_GRENADELAUNCHER",
	"WEAPON_RPG", "WEAPON_FIREWORK","WEAPON_RAILGUN", "WEAPON_MOLOTOV",
	"WEAPON_SNOWBALL", "VEHICLE_WEAPON_TANK"
};

std::vector<char*> weaponCar1 = {
	"None","STUNGUN", "GRENADE",
	"RPG", "FIREWORK", "RAILGUN", "MOLOTOV",
	"SNOWBALL", "TANK BULLET"
};

std::vector<char*> eventsidList = {
	"INFINITE LOADING", "TP TO APARTMENTS", "SEND INVITES", "SEND TO JOB", "SEND TO JOB 2",
	 "FORCE TO NEW SESSION", "CEO KICK", "CEO BAN", "TRANSACTION FAIL",
	"GTA BANNER EFFECT", "REMOVE WANTED LEVEL", "KICK FROM CAR", "CAMERA RESET",
	"FORCE TO NEW LOBBY"
};
...
std::vector<char*> eventsidListKicks = {
	...
	"KICK 17", "KICK 18", "KICK 19", "KICK 20",
	"KICK 21", "KICK 22", "KICK 23", "KICK 24",
...
std::vector<int> eventsid = {
	-0xA/*inf loading*/, TP_TO_APARTMENTS, SEND_INVITES, SEND_TO_JOB, SEND_TO_JOB_2,
	FORCE_TO_NEW_SESSION, CEO_KICK, CEO_BAN, TRANSACTION_FAIL,
	GTA_BANNER_EFFECT, REMOVE_WANTED_LEVEL,	KICK_FROM_CAR, RESET_CAM,
	FORCE_TO_NEW_SESSION
};

std::vector<int> eventsidKicks = {
	KICK_1, KICK_2, KICK_3, KICK_4,
	KICK_5, KICK_6, KICK_7, KICK_8,
	KICK_9, KICK_10, KICK_11, KICK_12,
	KICK_13, KICK_14, KICK_15, KICK_16,
	KICK_17, KICK_18, KICK_19, KICK_20,
	KICK_21, KICK_22, KICK_23, KICK_24,
	KICK_25, KICK_26, KICK_27, KICK_28,
	KICK_29, KICK_30, KICK_31, KICK_32,
	KICK_33, KICK_34, KICK_35, KICK_36,
	KICK_37, KICK_38, KICK_39, KICK_40
};

std::vector<char*> rpCorrectionChar = {
	"Both", "Char 1", "Char 2"
};

std::vector<LPCSTR> animalModels = { 
	"a_c_boar", "a_c_chimp", "a_c_cow", "a_c_coyote", "a_c_deer", 
	"a_c_fish", "a_c_hen", "a_c_cat_01", "a_c_chickenhawk", "a_c_cormorant", 
	"a_c_crow", "a_c_dolphin", "a_c_humpback", "a_c_killerwhale", "a_c_pigeon", 
	"a_c_seagull", "a_c_sharkhammer", "a_c_pig", "a_c_rat", "a_c_rhesus",
	"a_c_chop", "a_c_husky", "a_c_mtlion", "a_c_retriever", "a_c_gsharktiger",
	"a_c_shepherd" 
};
...
std::vector<char*> cars148_1 = {
"caracara2", "drafter", "dynasty", "emerus", "gauntlet3", "gauntlet4", "hellion", "issi7", "jugular", "krieger", "locust",
"nebula", "neo", "novak", "paragon", "paragon2", "peyote2", "rrocket", "s80", "thrax", "zion3", "zorrusso"
};


std::vector<char*> cars146_1 = {
	"bruiser",	"bruiser2",	"bruiser3",	"brutus",	"brutus2",	"brutus3",	"cerberus",	"cerberus2",	"cerberus3",	"clique",	"deathbike",
	"deathbike2",	"deathbike3",	"deveste",	"deviant",	"dominator4",	"dominator5",	"dominator6",	"impaler",	"impaler2",	"impaler3",
	"impaler4",	"imperator",	"imperator2",	"imperator3",	"issi4",	"issi5",	"issi6",	"italigto",	"monster3",	"monster4",	"monster5",
	"rcbandito","scarab","scarab2",	"scarab3", "schlagen",	"slamvan4",	"slamvan5",	"slamvan6",	"toros","tulip","vamos","zr380","zr3802","zr3803"
};
...
std::vector<char*> cars144_1 = {
	"stafford", "scramjet", "strikeforce", "terbyte", "pbus2",
	"oppressor2", "pounder2", "speedo4", "freecrawler", "mule4",
	"menacer", "blimp3", "swinger", "patriot2"
};

std::vector<char*> cars143_1 = {
	"michelli", "jester3", "flashgt", "tezeract", "entity2",
	"cheburek", "tyrant", "hotring", "ellie", "fagaloa",
	"gb200", "issi3", "taipan", "dominator3", "caracara",
	"seasparrow"
};

std::vector<char*> cars142_1 = {
